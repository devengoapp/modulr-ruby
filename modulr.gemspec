...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Aitor García Rey", "Fran Moya", "Techi Rexach", "Iván Guardado", "Carlos López", "Nacho Ortiz"]
  spec.email = ["aitor@devengo.com", "fran@devengo.com", "techi@devengo.com", "ivan@devengo.com", "carlos@devengo.com", "nacho@devengo.com"]
